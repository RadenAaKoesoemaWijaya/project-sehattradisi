        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-md p-8 text-center mb-6">
            ...
            <p className="text-gray-600 mb-6">
              Pesanan Anda telah dibuat. Silakan selesaikan pembayaran untuk mengkonfirmasi pemesanan.
            </p>
            ...
            {order.paymentMethod === 'bank_transfer' && (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6 text-left">
                <h3 className="font-semibold text-blue-900 mb-2">Informasi Transfer Bank:</h3>
                <div className="space-y-1 text-sm text-blue-800">
                  <p><strong>Bank:</strong> BCA</p>
                  <p><strong>No. Rekening:</strong> 1234567890</p>
                  <p><strong>Atas Nama:</strong> PT SehatTradisi Indonesia</p>
                  <p><strong>Jumlah:</strong> Rp{order.total.toLocaleString()}</p>
                </div>
              </div>
            )}
          </div>
